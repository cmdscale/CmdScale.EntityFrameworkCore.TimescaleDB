...
using static CmdScale.EntityFrameworkCore.TimescaleDB.Design.Features.ContinuousAggregatePolicy.ContinuousAggregatePolicyScaffoldingExtractor;
...
namespace CmdScale.EntityFrameworkCore.TimescaleDB.Design.Features.ContinuousAggregatePolicy
{
    ...
    /// </summary>
    internal sealed class ContinuousAggregatePolicyAnnotationApplier : IAnnotationApplier
    {
